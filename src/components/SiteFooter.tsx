...
export default function SiteFooter() {
  return (
    <footer style={{padding:"70px 40px 20px 40px", background: C.deep, color: C.sand }}>
      <div className="max-w-7xl mx-auto px-6 md:px-10 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          <div>
            ...
            <p className="text-sm leading-relaxed mb-6" style={{marginBottom:"10px", color: "#B8A090" }}>
          ...
          <div>
            <p className="font-semibold text-white mb-4 text-sm uppercase tracking-wider" style={{marginBottom:"10px",}}>Organisation</p>
          ...
          <div>
            <p className="font-semibold text-white mb-4 text-sm uppercase tracking-wider" style={{marginBottom:"10px",}}>Get Involved</p>
            <div className="flex flex-col gap-2.5">
          ...
          <div>
            <p className="font-semibold text-white mb-4 text-sm uppercase tracking-wider" style={{marginBottom:"10px",}}>Contact</p>
            ...
            <p className="text-sm font-semibold text-white mb-2" style={{margin:"10px 0px",}}>Newsletter</p>
            <div className="flex gap-2">
              <input type="email" placeholder="Your email" className="flex-1 text-sm px-3 py-2.5 rounded-full  outline-none"
                style={{ padding:"5px 10px", background: "rgba(255,255,255,0.08)", color: "white", border: "1px solid rgba(255,255,255,0.1)" }} />
              <button className="rounded-full text-white font-semibold text-sm transition-opacity hover:opacity-80" style={{ padding:"10px", background: C.gold }}>
                <ArrowRight className="w-4 h-4" />
              </button>
            </div>
          </div>
        </div>
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4" style={{marginTop:"40px", paddingTop:"20px", borderTop: "1px solid rgba(255,255,255,0.1)" }}>
